DROP DATABASE IF EXISTS SpotifyClone;
  ...
  CREATE TABLE SpotifyClone.planos(
    plano_id TINYINT AUTO_INCREMENT PRIMARY KEY,
  ...
  CREATE TABLE SpotifyClone.usuarios_seguindo(
    usuario_id INT NOT NULL,
    artista_id INT NOT NULL,
  ...
  INSERT INTO SpotifyClone.usuarios_seguindo(usuario_id, artista_id)
  VALUES
    (1, 1),
    (1, 2),
    (1, 3),
